...
namespace DVS
{
    public partial class Form2 : Form
    {
        ...
        private void manualRun_Click(object sender, EventArgs e)
        {
            ...
            {
                case "manualRun01":
                    DialogResult runResult01 = MessageBox.Show("此功能會重新匯入及刪除學生資料，請問您確定要匯入嗎？", "手動匯入設定--重新匯入及刪除學生資料", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    break;
                case "manualRun02":
                    DialogResult runResult02 = MessageBox.Show("此功能會重新匯入及刪除班級設定，請問您確定要匯入嗎？", "手動匯入設定--重新匯入及刪除班級設定", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (runResult02 == DialogResult.Yes)
                    {
                        //按了是
                        copyDataPanel.Location = new System.Drawing.Point(0, 22);
                        copyDataPanel.Size = new System.Drawing.Size(474, 270);
                    ...
                    else if (runResult02 == DialogResult.No)
                    {
                        //按了否
                    }
                    break;
                case "manualRun03":
                    DialogResult runResult03 = MessageBox.Show("此功能會重新刪除與匯入教室日誌，請問您確定要匯入嗎？", "手動匯入設定--重新匯入及刪除教室日誌", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (runResult03 == DialogResult.Yes)
                    {
                        //按了是
                        copyDataPanel.Location = new System.Drawing.Point(0, 22);
                        copyDataPanel.Size = new System.Drawing.Size(474, 270);
                    ...
                    else if (runResult03 == DialogResult.No)
                    {
                        //按了否
                    }
                    break;
